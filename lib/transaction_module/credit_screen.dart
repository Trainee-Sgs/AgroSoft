...
class _CreditScreenState extends State<CreditScreen>
  ...
  // Tab: 0 = Credit form, 1 = View List
  int _activeTab = 0;

  // Saved credits
  final List<_CreditEntry> _credits = [];
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: const Row(children: [
          ...
          SizedBox(width: 10),
          Text('Credit saved successfully!',
        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          Padding(
            ...
            child: Container(
              ...
              child: Row(children: [
                _tab('Credit', Icons.credit_card_rounded, 0),
  ...
  Widget _buildList() {
    if (_credits.isEmpty) {
      return Center(
        ...
        child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
          ...
          const Text('Save a credit to see it here',
    ...
    return ListView.builder(
      ...
      itemBuilder: (_, i) => _creditCard(_credits[i], i),
    );
  }

  Widget _creditCard(_CreditEntry e, int i) {
    return Container(
