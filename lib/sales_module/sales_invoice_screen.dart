...
class _SalesInvoiceScreenState extends State<SalesInvoiceScreen> {
  ...
  @override
  void dispose() {
    _supplierNameCtrl.dispose(); _supplierPhoneCtrl.dispose();
    _supplierAddressCtrl.dispose(); _supplierAadhaarCtrl.dispose();
    _referenceCtrl.dispose(); _supplierFocus.dispose();
    super.dispose();
  }
  ...
  Future<void> _pickDate({bool isDue = false}) async {
    ...
    if (picked != null) {
      setState(() => isDue ? _dueDate = picked : _selectedDate = picked);
    }
  }
                ...
                Expanded(
                  child: ListView(
                    ...
                    children: [
                      ...
                      // ── CHANGED: Product suggestions dropdown with green color ──
                      ...
                      // ── CHANGED: Discount + Tax in the SAME ROW ──────────
                      Row(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          // Discount column
  ...
  void _save() {
    ...
    setState(() {
      ...
      _supplierNameCtrl.clear(); _supplierPhoneCtrl.clear();
      _supplierAddressCtrl.clear(); _supplierAadhaarCtrl.clear();
              ...
              child: Row(children: [
                ...
                Expanded(child: Text(title,
                    style: const TextStyle(color: _C.textDark, fontSize: 15,
                        fontWeight: FontWeight.w700))),
                if (_items.isNotEmpty && sectionKey == _kOrderItems) ...[
                  Container(
      ...
      children: [
        ...
        Row(children: [
          Expanded(child: _TypeDropdown<TaxType>(
            label: 'Tax', value: _globalTaxType,
            items: const [
              DropdownMenuItem(value: TaxType.exclusive, child: Text('Exclude')),
              DropdownMenuItem(value: TaxType.inclusive, child: Text('Include')),
            ],
      ...
      children: [
        ...
        TextField(
          ...
          onChanged: (val) => setState(
                  () => _supplierSuggestions = SupplierNames.search(val)),
          decoration: InputDecoration(
        ...
        // ── CHANGED: Customer name suggestions with green background ──
          ...
          Container(
            ...
            child: ClipRRect(
              ...
              child: ListView.separated(
                ...
                separatorBuilder: (_, __) => Divider(
                    height: 1, color: _C.primary.withOpacity(0.2)),
                itemBuilder: (_, i) {
        ...
        const SizedBox(height: 6),
        _InputField(controller: _supplierPhoneCtrl,
        ...
        const SizedBox(height: 6),
        _InputField(controller: _supplierAadhaarCtrl,
        ...
        Row(children: [
          ...
          Expanded(child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 6),
              _InputField(controller: _referenceCtrl,
                ...
                Row(
                  children: [
                    Container(
                      ...
                      child: Text(
                        order.gstType == GstType.cgstSgst
                            ? 'CGST/SGST' : 'IGST',
                        style: const TextStyle(color: _C.primary,
                            fontSize: 11, fontWeight: FontWeight.w700),
                      ),
                    ...
                    if (order.supplierPhone.isNotEmpty) ...[
                      const SizedBox(width: 8),
                      const Icon(Icons.phone_rounded,
                          color: _C.textMid, size: 13),
                      const SizedBox(width: 4),
                      Text(order.supplierPhone,
  ...
  Widget build(BuildContext context) => TextField(
    ...
    decoration: InputDecoration(
      ...
      prefixIcon: icon != null
          ? Icon(icon, color: _C.primary, size: 20) : null,
      filled: true, fillColor: _C.bg,
      contentPadding: const EdgeInsets.symmetric(
          horizontal: 16, vertical: 14),
      border: OutlineInputBorder(borderRadius: BorderRadius.circular(14),
